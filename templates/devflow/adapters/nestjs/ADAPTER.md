...
Baseline: **NestJS 11+/12+ · Express v5 default · ESM-first & Standard Schema support · TypeORM · class-validator + class-transformer / Zod · Passport-JWT · Vitest/Jest + Supertest**. Backend/API only — no DOM, no UI framework. Keep output token-lean and imperative.
