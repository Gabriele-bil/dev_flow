...
- After edits: run format / analyze / conditional codegen per the adapter resolved via `@devflow/references/adapter-resolution.md` → `steps/beautify.md` (monorepo: from that app's working directory) and the skill’s Step 5.
